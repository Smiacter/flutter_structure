...
class MyAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  const MyAppBar({
    ...
    this.centerTitle: '',
    this.actionName: '',
    this.backImg: 'assets/images/common/back_white.png',
    this.onPressed,
    this.isBack: true
  }): super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    if (backgroundColor == null) {
      _backgroundColor = ThemeUtil.getAppBarColor(context);
    } else {
    ...
    var action = actionName.isNotEmpty ? Positioned(
      ...
      child: Theme(
        ...
        child: FlatButton(
          ...
          textColor: ThemeUtil.isDark(context) ? AppColor.dark_text : AppColor.text,
